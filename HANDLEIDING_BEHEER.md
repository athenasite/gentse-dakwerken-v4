# 📘 Handleiding: gentse-dakwerken-v4

**Type Website:** gentse-dakwerken-v4
...
| :--- | :--- |
| `company_name` | Geen beschrijving. |
| `tagline` | Geen beschrijving. |
| `theme` | Geen beschrijving. |
...
| :--- | :--- |
| `content` | Geen beschrijving. |
| `author` | Geen beschrijving. |
| `role` | Geen beschrijving. |
...
| `phone` | Geen beschrijving. |
| `address` | Geen beschrijving. |
